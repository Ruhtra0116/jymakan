...
def main():
    ...
    st.markdown(
        ...
        <style>
        .main {
            background-image: url('https://img.freepik.com/premium-photo/beautiful-colorful-music-note-background_731790-27346.jpg');
        ...
        right: 0;
        bottom: 0;
        background-color: rgba(255, 255, 255, 0.25); /* White overlay with 50% opacity */
